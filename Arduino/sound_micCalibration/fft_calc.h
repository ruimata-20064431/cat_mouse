/* data sample for pattern recognition 
...
// calculated FFT main frequencies of f1 =    ||  f2 = 

*/
//---------------------------------------------------------------------------//
// sine values for angles between [0..90] on a 255 scale where sin(ang) = sine_data[ang] / 255
//    => sin(  0) ==   0/255 == 0
//    => sin(255) == 255/255 == 1
