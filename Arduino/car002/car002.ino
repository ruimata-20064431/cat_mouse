...
MotorType motors[MTR_NUM] = { { .pinSpeed = 9,                                  // motor[0] control pins
                                .pinFwd   = 7,
                                .pinBkw   = 6},
                              { .pinSpeed = 3,                                  // motor[1] control pins
                                .pinFwd   = 4, 
                                .pinBkw   = 5} };

int motorConfig[2][2] = { {233, 100},                                           // motor0 (right)  {power limit, divider}
                          {255, 100}};                                          // motor1 (left)
...
void moveStraight(int direction, int distance, int speed){
  // for the moment, movement takes ownership of arduino for simplicity
    ...
    blink();                                                                     // movement stop visual indicator
}
...
void setup(){
    ...
    */
    /*
    // adjusted 87,5% motor right
    motorConfig[0][0] = 255;
    motorConfig[1][0] = 223;
    moveStraight(1, 6, 100);
    delay(5000);
    */
    /* almost straight. Starts straight but still turns to the right
    // adjusted 85% motor right
    motorConfig[0][0] = 255;
    motorConfig[1][0] = 217;
    moveStraight(1, 6, 100);
    delay(5000);
